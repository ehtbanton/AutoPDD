...
var useIsomorphicLayoutEffect = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : React__namespace.useEffect;
...
var vendor = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : defaultVendor;
...
var exitFullScreen = function(element) {
    return ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : Promise.resolve({});
};
...
var withTheme = function(theme, onSwitchTheme) {
    var initialTheme = React__namespace.useMemo(function() {
        return theme === 'auto' ? isDarkMode() ? ("TURBOPACK unreachable", undefined) : 'light' : theme;
    }, []);
