...
var useIsomorphicLayoutEffect = ("TURBOPACK compile-time truthy", 1) ? React__namespace.useLayoutEffect : ("TURBOPACK unreachable", undefined);
...
var vendor = ("TURBOPACK compile-time truthy", 1) ? Api.FullScreenEnabled in document && defaultVendor || webkitVendor.FullScreenEnabled in document && webkitVendor || msVendor.FullScreenEnabled in document && msVendor || defaultVendor : ("TURBOPACK unreachable", undefined);
...
var exitFullScreen = function(element) {
    return ("TURBOPACK compile-time truthy", 1) ? element[vendor.ExitFullScreen]() : ("TURBOPACK unreachable", undefined);
};
var getFullScreenElement = function() {
    return ("TURBOPACK compile-time truthy", 1) ? document[vendor.FullScreenElement] : ("TURBOPACK unreachable", undefined);
};
...
var isMac = function() {
    return ("TURBOPACK compile-time truthy", 1) ? /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform) : ("TURBOPACK unreachable", undefined);
};
...
var isDarkMode = function() {
    return "object" !== 'undefined' && window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches;
};
