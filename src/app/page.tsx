...
import { runPythonBackend, uploadContextFile, uploadTemplateFile, getOutputFileAsHtml, getExistingContextFiles, getTemplateName, stopPythonBackend } from '@/app/actions';
...
const Page: FC = () => {
    ...
    const handleStop = async () => {
        ...
        log("Stop signal sent to backend.");
    };
